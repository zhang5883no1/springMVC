...
<body>
<form id="slick-login" action="/app/controller/login/dologin" method="post" >  
	<label for="username">username</label><form:input type="text" path="loginDto.name" class="placeholder" placeholder="me@tutsplus.com" />
    <label for="password">password</label><form:input type="password" path="loginDto.pwd" class="placeholder" placeholder="password" />
